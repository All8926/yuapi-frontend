...
export async function getInitialState(): Promise<InitialState> {
  ...
  const fetchUserInfo = async (): Promise<API.BaseResponseUserVO | undefined> => {
    try {
  ...
  try {
    ...
    console.error(e,'getInitialState');
    history.push(loginPath);
  }
  return state;
}
  ...
  return {
    ...
    onPageChange: () => {
      ...
      if (!initialState?.loginUser && location.pathname !== loginPath) {
        console.log('onPageChange---initialState',initialState?.loginUser);
        history.push(loginPath);
      }
    },
    bgLayoutImgList: [
