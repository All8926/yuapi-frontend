...
/** InvokeInterfaceInfo POST /interface/invoke */
...
/** listInterfaceInfo GET /interface/list */
export async function listInterfaceInfoUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listInterfaceInfoUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseListInterfaceInfo>('/interface/list', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** listInterfaceInfoByPage GET /interface/list/page */
...
/** offLineInterfaceInfo POST /interface/offline */
